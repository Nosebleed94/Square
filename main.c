...
struct testing data [19] =
                           {{1,  1,      5,    6,    -2,              -3,       2},
                            ...
                            {9,  0,      5,    0,     0,               0,       1},
                            {10, 0,      0,    0,     0,               0,      -5},
                            {11, 2.3,    2.1, -32,   -4.21437,         3.30133, 2},
                            {12, 1,      2.2,  1.21, -1.1,             0,       1},
                            {13, 1.1,    4.4,  8.8,   0,               0,       0},
                            {14, 5.8,    5.5,  0,    -0.948276,        0,       2},
                            {15, 6.7,    0,    7.9,   0,               0,       0},
                            {16, 4.5,    0,   -9.3,  -1.43759,         1.43759, 2},
                            {17, 0,      5.3,  6.6,  -1.2452830188679, 0,       1},
                            {18, 0,      0,    7.798, 0,               0,       0},
                            {19, 0,      6.78, 0,     0,               0,       1}};
 int i;
 for( i = 0; i < nTests; i++)
